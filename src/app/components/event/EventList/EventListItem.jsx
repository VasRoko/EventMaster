  ...
  render() {
    ...
    return (
        ...
        <Segment>
            <Item.Group>
              <Item>
                <Item.Image as="a" size='tiny' src={event.hostPhotoURL || '/assets/img/events.jpg' } />
                <Item.Content>
                  <br/>
        ...
        <Segment>
          <span>
              <Icon name="clock" /> { event.date && format(event.date.toDate(), 'dddd Do MMMM')} at { format(event.date.toDate(), 'h:mm A')} |
